...
plt.title("u")
#plt.show()  
plt.savefig('/data3/bx/2D-poisson-PDE-Solver/poisson_solution.png', dpi=300, bbox_inches='tight')
print("Save in: /data3/bx/2D-poisson-PDE-Solver/poisson_solution.png")
